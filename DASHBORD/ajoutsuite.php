...
session_start();
    try
    {
        ...
        if(isset($_SESSION['email']) AND    !empty($_SESSION['email']))
        {
            ...
            {
                if(!isset($_POST['lib']) || empty($_POST['lib'])|| !isset($_POST['ctyp']) || empty($_POST['ctyp']) || !isset($_POST['prix']) || empty($_POST['prix']) 
                || !isset($_POST['file']) || empty($_POST['file']) || !isset($_POST['des']) || empty($_POST['des']) )
                {
...
<head>
    ...
    <link rel="stylesheet" href="./Ajoutsuite.css">
    <title>Ajout Suite</title>
</head>
<body>
    <section>
        <header>
            <div><p>AJOUT DE SUITE</p></div>
        </header>
     <div class="section">
        <aside>
                        ...
                        <form action="" method="POST">
                            <table> 
                                ...
                                <tr>
                                    <td>Code Type:</td>
                                    <td>
                                        <select class="info"name="ctyp" id="">
