...
<head>
    ...
    <link rel="stylesheet" href="./reservesuite.css">
    <title> Réservation de Suite</title>
</head>
<body>
        <div class="go">
                <nav class="nav">
 ...
 <?php
    ...
    <a href="./reservations.php"><input class="bouto" type="button" value="Réserver"></a>
    <?php } ?>
</div>
<hr>
<p class="j"><a class="voir" href="./voirsuite.php">Voir plus +</a></p>
    <hr>
    <footer>
            <div class="bas">
                <div class="ba">
