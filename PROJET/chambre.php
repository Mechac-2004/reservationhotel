...
<body>
    ...
    <div class="hap" >
        <p>
            <p>104 CHAMBRES      6 SUITES</P>
        </p>
    </div>
    <hr>
    <div class="lat">
        <div class="lot">
            <p ><img class="lo" src="./image/PHOTO/21.jpg" alt="Chambe1"></p>
            <p class="la">Catégorie: Suite </p>   
            <a href="./voirsuite.php"><input class="bouto" type="button" value="Réserver"></a></p>
        </div>
        <div class="lot">
            <p ><img class="lo" src="./image/cham5.jpg" alt="Chambe1"></p>
            <p class="la">Catégorie: Chambre simple </p>   
            <a href="./voirchambre.php"><input class="bouto" type="button" value="Réserver"></a></p>
        </div>
    </div>
    <hr>
    <footer>
