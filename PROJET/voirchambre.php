...
<head>
    ...
    <link rel="stylesheet" href="./voirchambre.css">
    <title>Chambre</title>
</head>
<body>
    <div class="go">
    ...
    <?php
        ...
        {?>    
            ...
            <p class="la">Catégorie: <?php echo $donnees['num_typ']?> </p>
            <p class="la">Catégorie: <?php echo $donnees['libel_chamb']?> </p>      
            <p class="la">Prix: <?php echo $donnees['prix']?> FCFA<br> <br>
            <a href="./reservechambre.php"><input class="bouto" type="button" value="Réserver"></a></p>
            </div>
    <?php } ?>
    </div>
    <hr>
    <footer>
            <div class="bas">
                <div class="ba">
                    <p class="ent">LIENS</p>
                    <div>
                        <a class="lien"   href="./acceuil.html"><p class="ite"> ACCEUIL</p></a>  
                    </div> 
                    <div>
                        <a class="lien"  href="./chambre.html"><p class="ite">Nos Chambres </p> </a> 
                   </div>
                   <div>
                     <a class="lien"  href="./inscription.html"><p class="ite">INSCRIPTION</p></a>  
                    </div>
                    <div>
                        <a class="lien"  href="./reservation.html"><p class="ite">RESERVATIONS</p> </a> 
                    </div>
                    <div>
                        <a class="lien"  href="./contacts.css"><p class="ite">CONTACTS</p> </a> 
                    </div>
                </div>
                <div class="ba">
