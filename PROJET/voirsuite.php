...
<head>
    ...
    <link rel="stylesheet" href="./Voirsuite.css">
    <title>Suite</title>
</head>
<body>
    <div class="go">
    ...
    <?php
        ...
        {?> 
            ...
            <p class="la">Nom: <?php echo $donnees['libel_chamb']?> </p>     
            <p class="la">Prix: <?php echo $donnees['prix']?> FCFA<br> <br>
            <a href="./reservesuite.php"><input class="bouto" type="button" value="Réserver"></a></p>
            </div>
    <?php } ?>
    <hr>
    <footer>
